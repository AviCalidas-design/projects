            ...
            try
            {
                switch(input)
                {
                    ...
                    case "Deposit":
                        ...
                        int accountID = yourAccounts.get(i-1).getId();
                        int amount = inputUtil.retrieveInt("How much money to deposit?");
                        accountService.updateBalance(accountID, yourAccounts.get(i-1).getBalance() + amount);
                    ...
                    case "Withdraw":
                        ...
                        int accountId = yourAccounts.get(x-1).getId();
                        int amt = inputUtil.retrieveInt("How much money to withdraw?");
                        accountService.updateBalance(accountId, yourAccounts.get(x-1).getBalance() - amt);
